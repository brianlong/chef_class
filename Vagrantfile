...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "brianlong-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/firstmoversadvantage"
  #   chef.validation_client_name = "firstmoversadvantage-validator"
  #   chef.validation_key_path = ".chef/firstmoversadvantage-validator.pem"
  # end
end
